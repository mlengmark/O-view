...
| **Scrape browser cookies** (ReferenceApp's approach for some providers) | Chrome/Edge now combine DPAPI with App-Bound Encryption; extracting cookies means defeating a security control. Rejected on both fragility and propriety. |
