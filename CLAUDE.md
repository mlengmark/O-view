...
### 2. Clean-room — do not read ReferenceApp

This project was inspired by [ReferenceApp](https://github.com/example/reference-app) (macOS/Swift). **Do not read, clone, fetch, or browse its source code**, and do not reproduce its naming or file layout. If asked "how does ReferenceApp do X", decline and reason from Windows/.NET documentation instead. Full policy: [ADR-0004](docs/adr/0004-clean-room-provenance.md).
